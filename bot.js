...
const youtube = new YouTube("AIzaSyC7NAnhImQRP-RB479LjQQeazOXhGHoTOQ"); //تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@658376062727749663>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
\`شرح البوت \` : <https://www.youtube.com/channel/UC_immFco3VMqrs7R2rlRYVw/featured>
`);
        })
        .then(e => {
          message.react("✅");
...
client.on("message", message => {
  if (message.content === "اليافعي") {
    message.channel.send("**:heart:االشيخ اليافعي شيخ من شيوخ اليافعي و رجال راعي فزعات و كفو:heart:**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === " باك") {
    message.channel.send("**:heart:ولكم:heart:**");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "بوت") {
    message.channel.send("**:heart:لبيه يا قلب البوت :heart:**");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name === "l og"); //// تعديل اساسي
      if (!channel) return;
